...
/*
 *  This test will attempt to delete a list by providing an invalid Session ID
 *  It will verify that the response status code 401 is generated with appropriate message.
 *  
 */

public class TC11_DeleteListInvalidSessionID extends baseClass{

	@Test
	public void deleteListInvalidSessionId() throws IOException
	{
		
		Common_Methods common=new Common_Methods();
		
		//Read test data from excel 
		String [][] inputData=common.getData("TC_TestData.xlsx","TC11");//pass the name of test data file and Sheet name
		...
		//Construct EndPoint
		String endPoint= String.join("","/3/list/",listId,"?api_key=",apiKey,"&session_id=xx",sessionId);
